...
class Buyer(models.Model):
    ...
    pic = models.FileField(upload_to="uploads",default="",null=True,blank=True)
    otp = models.IntegerField(default=-123234)
...
status = ((0,"Order Placed"),(1,"Not Packed"),(2,"Packed"),(3,"Ready to Ship"),(4,"Shipped"),(5,"Out for Delivery"),(6,"Deleivered"),(7,"Cancelled"))
